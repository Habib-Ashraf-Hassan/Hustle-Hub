<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="card" id="placereview" style="font-family: 'IBM Plex Sans', sans-serif; max-width: 60%; margin: 75px auto; border-radius: 10px; border: 1px solid #ccc;">
                    <div class="card-body">
                        ...
                        <center>
                            ...
                            <h3 style="margin-top: 2%">Review The technician</h3><br>
                            <form method="post" action="reviewact.php">
                                <div class="row register-form">
                                    <div class="col-md-12">
                                        <div class="form-group text-center">
                                            ...
                                            <textarea class="form-control" name="review" id="review" rows="4" maxlength="800" placeholder="Place your review here*" required></textarea>
                                        </div>
                                        <div class="form-group text-center">
