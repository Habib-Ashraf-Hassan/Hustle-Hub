...
if(isset($_SESSION['tid'])){
    ...
    $technician = gettechById($tid, $conn);
...
<!DOCTYPE html>
            <html>
            <head>
                <title>Technician Profile - HUSTLE HUB</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav" >
                ...
                <div class="custom-dropdown" style="margin-right: -100px;">
                    <button class="dropdown-toggle"><h3 class="profheader"><?php echo $username; ?></h3></button>
            ...
            <div class="container">
                    ...
                    <h3 style="margin-top: 2%">Your Profile</h3><br>
                        <form method="post" action="techupdate.php" onsubmit="return confirm('Are you sure you want to Update your profile?');">
                            <div class="row register-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fname">Fullname *</label>
                                        <input type="text" class="form-control" name="fname" id="fname" value="<?=$fullname?>" />
                                    </div>
                                    <input type="text" class="form-control" name="profession" id="profession" value="<?=$profession?>" hidden/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="gender" id="gender" onkeydown="return alphaOnly(event);" value="<?=$gender?>" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nid" id="nid" value="<?=$nid?>" />
                                    </div>

                                    <!-- <div class="form-group">
                                        <label for="fname">Description *</label>
                                        <input type="text" class="form-control" name="desc" id="desc" onkeydown="return alphaOnly(event);" value="" />
                                    </div> -->
                                    <div class="form-group">
                                        <label for="fname">Description *</label>
                                        <textarea class="form-control" name="desc" id="desc" rows="4" cols="800"><?=$desc?></textarea>
                                    </div>

                                    
                                    <div class="form-group">
                                        <input type="submit" class="btnRegister" name="techUpdate" value="Update"/>
                                    </div>
                                </div>
                            </div>
                        </form>
