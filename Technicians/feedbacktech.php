...
<!DOCTYPE html>
            <html>
            <head>
                <title>Technician Feedback - HUSTLE HUB</title>
            ...
            <div class="container">
                    ...
                    <h3 style="margin-top: 2%">Feedback</h3><br>
                    <form method="post" action="feedact.php">
                    <div class="row register-form">
                        <div class="col-md-12">
                            ...
                            <div class="form-group text-center">
                                <input type="submit" class="btnRegister" name="techFeedback" value="Submit"/>
                            </div>
                        </div>
                    </div>
                </form>
